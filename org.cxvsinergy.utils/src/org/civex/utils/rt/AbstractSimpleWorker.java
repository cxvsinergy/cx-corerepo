 ...
 * 	
 *******************************************************************/
public abstract class AbstractSimpleWorker<T> implements Runnable, Cloneable
{
	protected final T ctx;
	
	public AbstractSimpleWorker(T obj)
	{
		this.ctx=obj;
	}
	@Override
	...
	{
		AbstractSimpleWorker<T> r=(AbstractSimpleWorker<T>)super.clone();
		return r;
	}
